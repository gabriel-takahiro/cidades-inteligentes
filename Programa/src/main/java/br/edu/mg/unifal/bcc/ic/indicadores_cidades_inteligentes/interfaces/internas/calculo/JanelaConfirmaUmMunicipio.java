...
import br.edu.mg.unifal.bcc.ic.indicadores_cidades_inteligentes.interfaces.internas.calculo.resultado.MostrarResultadoParaUm;
...
public class JanelaConfirmaUmMunicipio extends JDialog {
	...
	/**
	 * Executa a interface que confirma o cálculo dos indicadores selecionados para
	 * todos um município
	 * 
	 * @param cep                          cep do município que deseja calcular os
	 *                                     indicadores
	 * @param data                         ano que será utilizado para calcular os
	 *                                     indicadores
							...
							public void run() {
								try {
									...
									List<IndicadoresBuscados> indicadoresCalculados = CalculoIndicador
											.calculaIndicadores(listaIndicadoresSelecionados, codigoMunicipio,
													data, recalcular, valorRetroativo);


									SwingUtilities.invokeLater(new Runnable() {
										public void run() {
											JanelaPrincipal.abrirJanelas(new MostrarResultadoParaUm(
													listaIndicadoresSelecionados, indicadoresCalculados, nomeMunicipio,
													codigoMunicipio, data, valorRetroativo, recalcular));
										}
									});

...
public class ValorVariavel {
	...
	/**
	 * Insere o valor da variável, caso o valor da variável ja esteja cadastrada no
	 * banco de dados, o valor é atualizado
	 * 
	 * @param codigo_variavel  código da variável
	 * @param codigo_municipio código do município
	 * @param data             ano
	 * @param resultado        valor da variável
	 * @param atualizado       indica se a variável está atualizada
	 * @param valor_oficial    indica se o valor da variável é oficial
	 */
	public static void inserirUpdateValorVariavel(int codigo_variavel, int codigo_municipio, String data,
			String resultado, boolean atualizado, boolean valor_oficial) {
		try (Connection connection = ConnectionFactory.recuperarConexao();) {
			...
			valorVariavelDAO.inserirUpdateValorVariavel(codigo_variavel, codigo_municipio, data, resultado, atualizado,
					valor_oficial);

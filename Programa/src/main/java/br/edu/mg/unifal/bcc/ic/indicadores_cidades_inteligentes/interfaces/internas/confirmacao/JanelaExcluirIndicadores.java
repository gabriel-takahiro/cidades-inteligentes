...
public class JanelaExcluirIndicadores extends JDialog {
	 ...
	 * @param listaIndicadores lista dos indicadores selecionados para exclusão
	 */
	public JanelaExcluirIndicadores(List<Indicador> listaIndicadores) {
			...
			buttonPane.setLayout(null);
			{
				...
				okButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						try {
							Indicador.excluir(listaIndicadores);
		...
		Indicador.mostrarIndicadores(table, listaIndicadores);

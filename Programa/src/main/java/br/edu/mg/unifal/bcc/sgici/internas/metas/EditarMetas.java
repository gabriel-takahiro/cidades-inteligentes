 ...
 * @version 0.3
 */
public class EditarMetas extends JanelasInternas {
	 ...
	 * janela EditarMetas na JanelaPrincipal.
	 */
	@Override
	protected void abrirJanelaJDesktopPane(JInternalFrame janela) {
		JanelaPrincipal.setJanelaEditarMetas((EditarMetas) janela);
	}

	/**
	 * Cria uma nova instância da classe EditarMetas.
	 */
	@Override
	protected JInternalFrame instanciaClasseAberta() {
		return new EditarMetas();
	}
}

...
/**
 * Classe responsável pela interface que confirma o cadastro da variável
 * 
...
public class JanelaConfirmaCadastroVariavel extends JDialog {
	...
	/**
	 * Executa a interface que confirma o cadastro da variável
	 */
	public JanelaConfirmaCadastroVariavel() {
		setBounds(100, 100, 259, 127);
		setTitle("Confirma o cadastro da variável");

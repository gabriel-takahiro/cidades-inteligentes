 ...
 * @version 0.3
 */
public class JanelaConfirmaCalculoTodosMunicipios extends JDialog {
	 ...
	 * indicadores selecionados para todos os municípios. Essa interface apresenta
	 * uma mensagem de confirmação e dois botões, um para confirmar e outro para
	 * cancelar a ação.
	 * 
	 ...
	 */
	public JanelaConfirmaCalculoTodosMunicipios(String data, boolean recalcular,
		...
		okButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				dispose();
				CalculaIndicador.calculoIndicadoresTodosMunicipios(listaIndicadoresSelecionados, valorRetroativo, data,
						recalcular);
			}
		});

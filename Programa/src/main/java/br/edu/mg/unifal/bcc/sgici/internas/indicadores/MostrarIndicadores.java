 ...
 *
 */
public class MostrarIndicadores extends JanelasInternas {
	 ...
	 * janela MostrarIndicadores na JanelaPrincipal.
	 */
	@Override
	protected void abrirJanelaJDesktopPane(JInternalFrame janela) {
		JanelaPrincipal.setJanelaMostrarIndicadores((MostrarIndicadores) janela);
	}

	/**
	 * Cria uma nova instância da classe MostrarIndicadores.
	 */
	@Override
	protected JInternalFrame instanciaClasseAberta() {
		return new MostrarIndicadores();
	}

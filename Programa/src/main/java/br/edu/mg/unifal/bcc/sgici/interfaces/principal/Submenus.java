...
public class Submenus {
	 ...
	 * @param menuBancoDados menu do banco de dados
	 */
	public static void restauraPadrao(JMenu menuBancoDados) {
		JMenuItem submenuRestaurarPadrao = new JMenuItem("Restaurar padrão");
		submenuRestaurarPadrao.addActionListener(new ActionListener() {
			/**
			 * Abre a interface que importa as tabelas no banco de dados
			 */
			public void actionPerformed(ActionEvent e) {
				JanelaPrincipal.restaurarPadrao();
			}
		});
		menuBancoDados.add(submenuRestaurarPadrao);
		listaSubmenus.add(submenuRestaurarPadrao);
	}

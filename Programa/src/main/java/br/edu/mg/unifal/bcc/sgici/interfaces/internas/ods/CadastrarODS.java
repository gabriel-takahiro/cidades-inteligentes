 ...
 *
 */
public class CadastrarODS extends JanelasInternas {
	 ...
	 * janela CadastrarODS na JanelaPrincipal.
	 */
	@Override
	protected void abrirJanelaJDesktopPane(JInternalFrame janela) {
		JanelaPrincipal.setJanelaCadastrarODS((CadastrarODS) janela);
	}

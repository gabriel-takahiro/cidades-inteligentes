...
*/
package br.edu.mg.unifal.bcc.ic.indicadores_cidades_inteligentes.interfaces.internas.calculo.resultado;
	...
	public TabelaIndicadoresCalculados(ArrayList<Integer> listaIndicadoresSelecionados, String nomeMunicipio,
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
						.addComponent(lblIndicadoresSemValor, GroupLayout.DEFAULT_SIZE, 681, Short.MAX_VALUE)
		...
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				...
				.addPreferredGap(ComponentPlacement.RELATED)
				.addComponent(scrollPaneTabelaIndicadoresComResultado, GroupLayout.PREFERRED_SIZE, 215,
				...
				.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(scrollPaneTabelaIndicadoresSemResultado,

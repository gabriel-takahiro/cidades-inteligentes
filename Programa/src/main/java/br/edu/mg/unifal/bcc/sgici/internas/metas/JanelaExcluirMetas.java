...
/**
 * Classe responsável pela interface que exclui as metas
 * 
...
public class JanelaExcluirMetas extends JDialog {
	...
	/**
	 * Executa a interface que exclui as metas
	 * 
	 * @param listaMetas lista de metas a serem excluídas
	 */
	public JanelaExcluirMetas(List<Meta> listaMetas) {
		...
		try {
			...
			dispose();
			new JanelaMensagem("É necessário selecionar pelo menos 1 meta.");
			return;
		}

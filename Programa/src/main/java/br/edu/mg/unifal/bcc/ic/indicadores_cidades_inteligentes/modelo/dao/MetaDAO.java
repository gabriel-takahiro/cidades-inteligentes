...
public class MetaDAO {
	...
	/**
	 * Busca todas as informações da meta a partir do número da meta e do número da ods
	...
	/**
	 * Exclui da tabela "meta" uma meta a partir do número da meta e do número da ods

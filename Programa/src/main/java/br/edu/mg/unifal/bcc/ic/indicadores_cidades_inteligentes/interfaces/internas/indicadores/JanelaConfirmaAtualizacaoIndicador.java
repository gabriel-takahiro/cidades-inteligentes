...
/**
 * Classe responsável pela interface que confirma a atualização do indicador
...
public class JanelaConfirmaAtualizacaoIndicador extends JDialog {
	...
	/**
	 * Executa a interface que confirma a atualização do indicador
	 * @param indicador indicador a ser atualizado
	 * @param janelaAtualizarIndicadores interface da atualização do indicador
	 */
	public JanelaConfirmaAtualizacaoIndicador(Indicador indicador, JanelaAtualizarIndicadores janelaAtualizarIndicadores) {
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						JanelaAtualizarIndicadores.atualizarIndicador(indicador, janelaAtualizarIndicadores);
						dispose();
					}
				});

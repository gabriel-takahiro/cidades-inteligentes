...
/**
 * Classe responsável pela interface que confirma a limpeza de todos os campos
 * da interface de cadastro ou da interface de atualização dos indicadores
 * 
...
public class JanelaConfirmaLimpeza extends JDialog {
	...
	/**
	 * Executa a interface que confirma a limpeza de todos os campos da interface de
	 * cadastro ou da interface de atualização dos indicadores
	 * 
	 * @param cadastro true para interface de cadastro e false para de atualização
	 */
	public JanelaConfirmaLimpeza(boolean cadastro) {
		setBounds(100, 100, 267, 127);
		setTitle("Confirma limpeza");

...
/**
 * Classe responsável pela interface que exibe os logs do banco de dados
 * 
...
public class LogBancoDados extends JInternalFrame {
	...
	/**
	 * Executa a interface responsável pela exibição dos logs do banco de dados
	 * @param operacoes lista dos logs do banco de dados
	 */

...
/**
 * Esta classe representa uma janela de mensagem que exibe uma mensagem na tela
 * e um botão OK para fechar a janela.Ela é usada para exibir mensagens
 * informativas para o usuário do sistema.
 * 
...
public class JanelaMensagem extends JDialog {
	...
	/**
	 * Cria uma nova janela de mensagem com a mensagem especificada.
	 * 
	...
	public JanelaMensagem(String mensagem) {
		...
		gl_contentPanel
				.setHorizontalGroup(
						gl_contentPanel.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_contentPanel.createSequentialGroup().addGap(194)
										.addComponent(btnNewButton, GroupLayout.PREFERRED_SIZE, 89,
												GroupLayout.PREFERRED_SIZE)
										.addContainerGap(201, Short.MAX_VALUE))
								.addComponent(scrollPane, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 484,
										Short.MAX_VALUE));
		...
		// Configura as propriedades da janela de mensagem.

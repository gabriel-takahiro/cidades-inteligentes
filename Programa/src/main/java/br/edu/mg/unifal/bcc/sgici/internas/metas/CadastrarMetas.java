 ...
 *
 */
public class CadastrarMetas extends JanelasInternas {
	 ...
	 * janela CadastrarMetas na JanelaPrincipal.
	 */
	@Override
	protected void abrirJanelaJDesktopPane(JInternalFrame janela) {
		JanelaPrincipal.setJanelaCadastrarMetas((CadastrarMetas) janela);
	}

	/**
	 * Cria uma nova instância da classe CadastrarMetas.
	 */
	@Override
	protected JInternalFrame instanciaClasseAberta() {
		return new CadastrarMetas();
	}

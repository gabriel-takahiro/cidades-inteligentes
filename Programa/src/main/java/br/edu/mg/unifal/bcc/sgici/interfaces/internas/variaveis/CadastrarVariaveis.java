 ...
 *
 */
public class CadastrarVariaveis extends JanelasInternas {
	 ...
	 * janela CadastrarVariaveis na JanelaPrincipal.
	 */
	@Override
	protected void abrirJanelaJDesktopPane(JInternalFrame janela) {
		JanelaPrincipal.setJanelaCadastrarVariaveis((CadastrarVariaveis) janela);
	}

	/**
	 * Cria uma nova instância da classe CadastrarVariaveis.
	 */
	@Override
	protected JInternalFrame instanciaClasseAberta() {
		return new CadastrarVariaveis();
	}
}

 ...
 *
 */
public class EditarODS extends JanelasInternas {
	 ...
	 * janela EditarODS na JanelaPrincipal.
	 */
	@Override
	protected void abrirJanelaJDesktopPane(JInternalFrame janela) {
		JanelaPrincipal.setJanelaEditarODS((EditarODS) janela);
	}

	/**
	 * Cria uma nova instância da classe EditarODS.
	 */
	@Override
	protected JInternalFrame instanciaClasseAberta() {
		return new EditarODS();
	}
}

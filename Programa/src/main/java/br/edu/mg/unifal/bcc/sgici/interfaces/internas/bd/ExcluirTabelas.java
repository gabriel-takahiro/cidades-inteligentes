...
/**
 * Classe responsável por excluir tabelas no banco de dados.
 * 
 * <p>
 * Esta classe possui uma interface gráfica que permite ao usuário excluir todas
 ...
 * @version 0.3
 */
public class ExcluirTabelas extends JanelasInternas {

	private static final long serialVersionUID = 1L;

	/**
	 * Cria uma nova janela de exclusão de tabelas.
	 */
	public ExcluirTabelas() {
		...
		btnSim.addActionListener(new ActionListener() {
			/**
			 * Excluir todas as tabelas do banco de dados
			 */
			public void actionPerformed(ActionEvent e) {
				new ConfirmaPorEscrito("Excluir");
				dispose();
			}
		});
	 ...
	 * janela ExcluirTabelas na JanelaPrincipal.
	 */
	@Override
	protected void abrirJanelaJDesktopPane(JInternalFrame janela) {
		JanelaPrincipal.setJanelaExcluirTabelas((ExcluirTabelas) janela);
	}

	/**
	 * Cria uma nova instância da classe ExcluirTabelas.
	 */
	@Override
	protected JInternalFrame instanciaClasseAberta() {
		return new ExcluirTabelas();
	}
}

...
*/
package br.edu.mg.unifal.bcc.ic.indicadores_cidades_inteligentes.interfaces.internas.ods;
...
/**
 * Classe responsável pela interface que exclui as ods
 * 
 * @author Gabriel Takahiro
 * @version 0.3
 */
public class JanelaExcluirODS extends JDialog {
	...
	/**
	 * Executa a interface que exclui as ods
	 * @param listaODS lista das ods selecionadas para exclusão
	 */
	public JanelaExcluirODS(List<ODS> listaODS) {
		setTitle("Excluir ODS");
		...
		JLabel lblNewLabel = new JLabel("Deseja excluir as ODS:");
		...
		try {
			ODS.mostrarODS(table, listaODS);
		} catch (Exception e) {
			dispose();
			new JanelaMensagem("É necessário selecionar pelo menos 1 ODS.");
			return;
		}

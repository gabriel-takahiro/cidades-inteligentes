...
/**
 * Esta classe fornece uma maneira de retornar o resultado da operação e a
 * posição do ponteiro no cálculo de prioridade de soma ou subtração.
 * 
...
public class CalculoPrioridadeSomaSub {
	...
	/**
	 * 
	 * @param calculo resultado da operação

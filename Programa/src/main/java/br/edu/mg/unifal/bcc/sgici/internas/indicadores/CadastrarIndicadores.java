 ...
 *
 */
public class CadastrarIndicadores extends JanelasInternas {
	 ...
	 * janela CadastrarIndicadores na JanelaPrincipal.
	 */
	@Override
	protected void abrirJanelaJDesktopPane(JInternalFrame janela) {
		JanelaPrincipal.setJanelaCadastrarIndicadores((CadastrarIndicadores) janela);
	}

	/**
	 * Cria uma nova instância da classe CadastrarIndicadores.
	 */
	@Override
	protected JInternalFrame instanciaClasseAberta() {
		return new CadastrarIndicadores();
	}
}

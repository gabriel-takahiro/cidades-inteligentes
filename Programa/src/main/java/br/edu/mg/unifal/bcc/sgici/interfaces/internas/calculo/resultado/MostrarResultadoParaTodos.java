...
/**
 * Classe responsável pela interface que permite que o usuário escolha um CEP
 * para visualizar os resultados obtida para este município. Esta interface
 * aparece apenas quando for realizado o cálculo de indicadores para todos os
 * municípios.
 * 
...
public class MostrarResultadoParaTodos extends JInternalFrame {
	 ...
	 *                                     recalculados ou não
	 */
	public MostrarResultadoParaTodos(ArrayList<Integer> listaIndicadoresSelecionados, String data, int valorRetroativo,
			boolean recalcular) {
